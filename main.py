...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://build-a-blog:Shrestha@123@localhost:8889/build-a-blog'
...
def new_post():
    ...
    if request.method == "POST":
        ...
        if not title_error and not post_error:
            ...
            return render_template("addblog.html",title_error=title_error, post_error=post_error)
